...
for line in lines:
    ...
    # The inverted index should be case insensitive. Convert upper case characters to lower case using casefold().

    # Split the text into whitespace-delimited terms.
    # Remove stop words. We have provided a list of stop words in inverted_index/stopwords.txt.
